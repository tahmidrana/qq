                                            ...
                                            <div class="all-answers-body-main">
                                                ...
                                                <div class="all-answeres">
                                                    <div class="answers-all">
                                                        ...
                                                        <div class="user-area">
                                                            <p>answered at <span style="color: #E87C71"><?php echo $hlp->dateFormate($answers['datetime']); ?></span> by <a href="admin/" style="color: #E87C71"><?php echo $hlp->nameModify($answers['us_name']); ?></a></p>
                                                            <span class="add-comment">Add a comment</span>
                                                        </div>
                                                        <div class="comments">
                                                            <p>Comment 1</p>
                                                            <p>commented at <span style="color: #E87C71">15 nov 2016 at 2:10pm</span> by <a href="" style="color: #E87C71">Tahmidur</a></p>
                                                        </div>
                                                    </div>
                                                </div>
